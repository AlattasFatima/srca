...
const TOPICS = [
  ...
  { id: "t2", title: "المحاضرات الـ ", body: "سيدرج النص لاحقًا" },
  {
    id: "t3",
    title: "موضوع متفرّع",
    children: [
      ...
      { id: "t3-a2", title: "سياسات ... للجودة", body: "سيدرج النص لاحقًا" },
    ],
  },
  { id: "t4", title: "أفضل الـ... أثناء الإ... ", body: "سيدرج النص لاحقًا" },
];
