...
function AboutUs() {
  return (
    <div id="about" className="min-h-[80vh] w-full pt-10">
      ...
      <div className="py-5 px-20 mb-8 text-center text-2xl md:text-3xl font-semibold text-red-900"
      data-aos="fade-down" data-aos-duration="500">
        من نحن؟
      </div>

      <div className="py-5 px-20 mx-20 lg:mx-44 xl:mx-77 text-lg md:text-2xl border border-gray-100 hover:border-neutral-500 rounded-lg shadow-lg mb-6" 
        ...
        <section className="flex flex-col md:flex-row items-center justify-between">
          ...
          <p className="flex-1 py-4 text-center md:text-right font-normal text-neutral-700">
            <span className="font-semibold text-red-900 ">رؤيتنا</span>
            <br />
      ...
      <div className="py-5 px-20 mx-20 lg:mx-44 xl:mx-77 text-right text-lg md:text-2xl border border-gray-100 hover:border-neutral-500 rounded-lg shadow-md mb-6"
      data-aos="fade-right" data-aos-duration="2500">
        <section className="flex flex-col md:flex-row items-center justify-between">
          ...
          <p className="flex-1  py-4 text-center md:text-right font-normal text-neutral-700">
            <span className="font-semibold text-red-900">رسالتنا</span>
            <br />
      ...
      <section className="py-5 px-20 mt-20 text-lg md:text-2xl">
        ...
        <p className="flex-1 px-10 lg:px-44 pb-4 mb-8 text-center md:text-right font-normal text-neutral-700" 
        data-aos="fade-left" data-aos-duration="2500">
          يقف خلف هذه المنصة فريق واحد متكامل من اخصائيين ضمان جودة وتطوير إرسال الطوارئ، 
          يعملون بروح مشتركة في تمكين المرحّل الطبي من أداء دوره الحيوي بكفاءة
          وفعالية لتقديم محتوى تدريبي متجدد وتجربة تعليمية ملهمة تسهم في جودة الاستجابة الإسعافية وإنقاذ الأرواح.
        </p>
      </section>
