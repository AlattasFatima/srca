  ...
  return (
    <div id="about" dir="rtl" className="relative isolate min-h-[80vh] w-full pt-10">
      ...
      <div className="relative z-10 py-5 px-6 md:px-10 mx-6 md:mx-12 lg:mx-28 text-lg/8 md:text-2xl/10
        ...
        <section className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="flex-1 py-2 text-center md:text-right text-neutral-700">
            <span className="text-2xl md:text-3xl lg:text-4xl font-semibold text-red-900">رؤيتنا</span>
            <br />
      ...
      <div
        ...
        <section className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="flex-1 py-2 text-center md:text-right font-normal text-neutral-700">
            <span className="text-2xl md:text-3xl lg:text-4xl font-semibold text-red-900">رسالتنا</span>
            <br />
      ...
      <section className="relative z-10 px-6 md:px-12 lg:px-28 pb-4 mt-12 text-lg md:text-2xl">
        <img src={team}
          className="h-auto w-full max-w-4xl mx-auto rounded-md"
      ...
      {/*Footer*/}
      <footer id="footer" dir="ltr" className="relative z-10 w-full bg-red-900 text-white text-lg p-6">
        <div className="container mx-auto flex flex-row justify-between items-center px-4">
          <p className="mb-0 text-right">&copy; {new Date().getFullYear()} جميع الحقوق محفوظة</p>

          <div className="flex space-x-6 text-2xl">
            <a href="mailto:EMD.660@srca.org.sa?subject=استفسار&body=السلام عليكم،"
              className="hover:text-blue-300 transition-colors"
              title="راسلنا عبر البريد الإلكتروني">
              <FaEnvelope />
            </a>

            <a href="tel:0112805555,22381"
